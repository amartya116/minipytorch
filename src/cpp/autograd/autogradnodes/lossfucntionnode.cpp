...
TensorImpl* lossfunctionnode(TensorImpl* input1, const vector<float>& target)
{
    ...
    TensorImpl *activationnoderelu = new TensorImpl(resultStorage, resultGradStorage, input1->shape, input1->strides, 0,
